...
```javascript
import descriptor from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-descriptor@esm/index.mjs';
```
...
import getOffset from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-offset@esm/index.mjs';
